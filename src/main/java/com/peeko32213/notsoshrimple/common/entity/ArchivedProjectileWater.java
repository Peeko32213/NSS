...
public class ArchivedProjectileWater extends AbstractHurtingProjectile implements IAnimatable {
    ...
    public ArchivedProjectileWater(EntityType<? extends Projectile> p_37248_, Level p_37249_) {
    ...
    public void registerControllers(AnimationData data) {
        ...
        AnimationController<ArchivedProjectileWater> controller = new AnimationController<>(this, "controller", 1, this::predicate);
